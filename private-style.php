 ...
 * Version:1.0.0
 * Author: Deep Rahman
 * Description: Hide content if the user is not logged in, and decorate the content using custom css.
 */

add_shortcode( 'private', 'ch2pit_private_shortcode' );

function ch2pit_private_shortcode( $atts, $content ) {
    ob_start();
   ?>
...
register_activation_hook( __FILE__,
                          ...
                          function ch2pit_set_default_options_array() {
                            if ( get_option( 'ch2pit_options' ) === false ) {
                                $stylesheet_location =
                                    plugin_dir_path( __FILE__ ) . 'stylesheet.css';                  $options['stylesheet'] =
                        ...
                        function ch2pit_settings_menu() {
                            add_menu_page('Private Item Text Configuration', 
